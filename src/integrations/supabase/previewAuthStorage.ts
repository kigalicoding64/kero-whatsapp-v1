...
// Create an in-memory storage fallback if localStorage throws SecurityError or is blocked
...
export function getSafeStorage(): Storage {
  ...
  try {
    ...
    console.warn(
      "[Auth] Browser blocked direct localStorage access. Falling back to memory storage.",
    );
...
// postMessage so the project's preview surfaces share one login; else safe localStorage.
export function brokeredPreviewStorage() {
  ...
  if (!projectId || !framed) return safeStorage;
